		...
		<main className="page-shell py-8 lg:py-10">
			<div className="mb-6 rounded-[2rem] border border-white/10 bg-white/[0.03] p-6">
				...
				<p className="mt-4 max-w-3xl text-smoke">
					...
					priority, and reminders in a clean MVP flow aligned to the
					backend task schema.
				</p>
			</div>
				...
				<form onSubmit={handleSubmit} className="space-y-6">
					...
					{submitted ? (
						<div className="rounded-[2rem] border border-glow/20 bg-glow/10 p-5 text-sm text-pearl">
							Task drafted locally. In the next backend pass, this
							form can post directly to the /tasks endpoint.
						</div>
					) : null}
				</form>
				...
				<aside className="space-y-6">
					...
					<div className="glass-panel rounded-[2rem] p-6">
						...
						<div className="mt-4 space-y-3 text-sm leading-6 text-smoke">
							...
							<p>
								• This UI keeps the backend shape in mind, but
								remains frontend-first.
							</p>
							<p>
								• Recurring schedules and smart reminders are
								ready for the API layer later.
							</p>
						</div>
					</div>
				</aside>
